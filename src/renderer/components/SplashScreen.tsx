...
import { convertVersion } from '../lib/utils'
...
export const SplashScreen = ({
    ...
    useEffect(() => {
        if (window.electronAPI && window.electronAPI.displaySplashScreen) {
            const unsubscribe = window.electronAPI.displaySplashScreen(
    ...
    const handlerDoNotDisplayAgain = async (event: CheckedState) => {
