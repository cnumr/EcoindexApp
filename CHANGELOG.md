...
- 4f288d2: Bump `lighthouse-plugin-ecoindex-core` and `lighthouse-plugin-ecoindex-courses` from 7.3.1 to 7.3.4
    - Bump `puppeteer` and `puppeteer-core` from 24.x to 25.1.0
    - Bump `@puppeteer/browsers` from 2.13.0 to 3.0.4
    - Bump `chromium-bidi` from 14.0.0 to 16.0.1

- 26d4949: Security bumps: electron, vite, react-router-dom
...
- a2d128c: Add lang flag (EN|FR) to AdvConfiguration UI and synchronize all advanced config fields between Simple and JSON tabs
...
- e68c6c4: chore: update lighthouse-plugin-ecoindex-courses to version 7.0.1

## 0.11.0

### Minor Changes

- 36d620b: ### Amélioration de la sécurité et de l'expérience utilisateur dans KeyValue
